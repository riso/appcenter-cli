...
let CodePushReleaseReactCommand = class CodePushReleaseReactCommand extends codepush_release_command_base_1.default {
    run(client) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!react_native_utils_1.isReactNativeProject()) {
            ...
            try {
                ...
                if (this.os === "android") {
                    const isHermesEnabled = yield react_native_utils_1.getHermesEnabled(this.gradleFile);
                    if (isHermesEnabled) {
                        yield react_native_utils_1.runHermesEmitBinaryCommand(this.bundleName, this.updateContentsPath, this.sourcemapOutput, this.extraHermesFlags);
                    }
                }
